			...
			<div className="space-y-8">
				<div>
					...
					<p className="mt-2 max-w-2xl text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
						<strong className="text-zinc-800 dark:text-zinc-200">OAuth Client ID</strong> for Claude Code and
						claude.ai is in the card below — it is <strong className="text-zinc-800 dark:text-zinc-200">not</strong>{" "}
						the same as an API key (<code className="rounded bg-zinc-100 px-1 text-xs dark:bg-zinc-800">ak_…</code>)
						or an MCP token (<code className="rounded bg-zinc-100 px-1 text-xs dark:bg-zinc-800">aadm_…</code>).

		...
		<>
			<section className="rounded-xl border border-violet-200 bg-violet-50/50 p-5 dark:border-violet-900 dark:bg-violet-950/20">
				...
				<p className="mt-2 text-sm text-violet-900/80 dark:text-violet-200/80">
					...
					<code className="rounded bg-violet-100/80 px-1 text-xs dark:bg-violet-900/60">aadm_</code>, on the tokens page)
					or a <strong className="text-violet-950 dark:text-violet-100">Clerk API key</strong> (
					<code className="rounded bg-violet-100/80 px-1 text-xs dark:bg-violet-900/60">ak_</code>) from your Clerk account.
					Below you can also register an <strong className="text-violet-950 dark:text-violet-100">OAuth application</strong>{" "}
					(client id and secret) for apps that use the authorization code flow against this account.
				</p>
				<Link
			...
			<div>
				<h1 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50">Account</h1>
				<p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
					Profile, OAuth clients for integrations, and MCP tokens (linked above).
				</p>
			</div>
			...
			<section className="rounded-lg border border-zinc-200 p-6 dark:border-zinc-800">
				...
				<form onSubmit={handleUpdateProfile} className="space-y-4">
					<div>
						...
						/>
						<p className="text-xs text-zinc-500 mt-1">Email is managed through Clerk account settings.</p>
					</div>

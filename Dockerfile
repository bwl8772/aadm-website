...
#   CLERK_OAUTH_CLIENT_ID         member MCP OAuth tab — read at runtime via process.env (not build args)
...
ARG PUBLIC_CLERK_SIGN_IN_FALLBACK_REDIRECT_URL=""
ARG PUBLIC_CLERK_SIGN_UP_FALLBACK_REDIRECT_URL=""
ARG PUBLIC_CLERK_IS_SATELLITE=""
ARG PUBLIC_CLERK_DOMAIN=""
ARG PUBLIC_CLERK_PROXY_URL=""
ARG PUBLIC_MEMBER_AREA_PATH=""
...
ENV PUBLIC_STANDARD_REPO_URL=$PUBLIC_STANDARD_REPO_URL \
	...
	PUBLIC_CLERK_IS_SATELLITE=$PUBLIC_CLERK_IS_SATELLITE \
	PUBLIC_CLERK_DOMAIN=$PUBLIC_CLERK_DOMAIN \
	PUBLIC_CLERK_PROXY_URL=$PUBLIC_CLERK_PROXY_URL \
	PUBLIC_MEMBER_AREA_PATH=$PUBLIC_MEMBER_AREA_PATH
